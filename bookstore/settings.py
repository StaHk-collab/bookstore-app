...
DISCOUNT_TYPE = config('DISCOUNT_TYPE', default='flat')
DISCOUNT_VALUE = config('DISCOUNT_VALUE', default=0.0, cast=float)
...
SECRET_KEY = 'django-insecure--lq@a*km4((ki)ca-c&pn*x5m0-&p93)vsx99dh0!mzb)g9(^f'
